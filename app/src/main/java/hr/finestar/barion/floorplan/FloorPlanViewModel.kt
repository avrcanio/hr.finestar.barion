package hr.finestar.barion.floorplan
...
import hr.finestar.barion.domain.usecase.CreateCheckForTableUseCase
import hr.finestar.barion.domain.usecase.GetAllowedLayoutsUseCase
import hr.finestar.barion.domain.usecase.GetFloorTablesUseCase
import hr.finestar.barion.domain.usecase.GetOpenCheckForTableUseCase
import hr.finestar.barion.domain.usecase.GetRuntimeModeUseCase
...
class FloorPlanViewModel @Inject constructor(
    ...
    private suspend fun applyFloorPlan(
        floorPlan: hr.finestar.barion.domain.model.FloorPlanData,
