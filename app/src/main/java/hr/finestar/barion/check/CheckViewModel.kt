...
class CheckViewModel @Inject constructor(
    ...
    private fun settlePart(
        ...
        action: suspend () -> hr.finestar.barion.domain.model.SettlementPart
    ) {
    ...
    private suspend fun refreshSettlementStateNow(): hr.finestar.barion.domain.model.SettlementState? {
        var latest: hr.finestar.barion.domain.model.SettlementState? = null
    ...
    private fun applySettlementState(settlementState: hr.finestar.barion.domain.model.SettlementState) {
        _uiState.update { state ->
